                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td>{{ $category->slug }}</td>
                                            <td>{{ $category->position }}</td> <!-- Hiển thị thứ tự của danh mục -->
                                            <td>
        ...
        $(document).ready(function() {
            $('.dataTables-categories').DataTable({
                ...
                buttons: [
                    { extend: 'copy' },
                    { extend: 'csv' },
                    { extend: 'excel', title: 'DanhSachLoaiSanPham' },
                    { extend: 'pdf', title: 'DanhSachLoaiSanPham' },
                    { extend: 'print', title: 'DanhSachLoaiSanPham',
